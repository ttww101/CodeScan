...
#import "JMTWebProgressView.h"
#import "UIView+Extension.h"

@interface MBaseWebViewController ()<UIWebViewDelegate>
@property (nonatomic, weak) UIWebView *cloudShareView;
@property (nonatomic, strong) JMTWebProgressView *progressLayer;
@end

@implementation MBaseWebViewController
...
- (void)loadRequest:(NSString *)urlString
{
    ...
    self.progressLayer = [JMTWebProgressView new];
