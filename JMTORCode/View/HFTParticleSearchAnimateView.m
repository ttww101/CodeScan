...
#import "HFTParticleSearchAnimateView.h"
...
@interface HFTParticleSearchAnimateView () {
    //是否正在运动
    BOOL _starting;
...
@implementation HFTParticleSearchAnimateView
...
- (void)customSubviewsWithRate:(CGFloat)rate {
    ...
    self.emitter.shadowColor = [UIColor redColor].CGColor;
